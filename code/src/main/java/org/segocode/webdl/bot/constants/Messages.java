package org.segocode.webdl.bot.constants;
...
public class Messages {
    ...
    public static final String DOWNLOAD_REQUEST_ERROR =
            "❌ Unable to download: web not supported, private post or reach limit";
}
